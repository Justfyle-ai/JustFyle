...
const navItems = [
  { href: '/chat', label: 'Tax Chat', icon: MessageSquare, description: 'Chat with your AI tax assistant' },
  { href: '/documents', label: 'Documents', icon: FileText, description: 'Upload & manage tax documents' },
  { href: '/tax-planning', label: 'Tax Planning', icon: PiggyBank, description: 'Strategies to save next year' },
